                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"><img src={account} className="menu__img"/>
                                               {/*<h4 className="text-gray-700 bg-white hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">*/}
                                                   {/*{user.name}*/}
                                               {/*</h4>*/}
                                            </button>
                                        </span>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link href='/profile/edit'>Профиль</Dropdown.Link>
                            ...
                            <div className="footer__top">
                                ...
                                <div className="footer__box">
                                    <ul className="footer_menu2">
                                        <li className="footer_menu_item2"><Link href="/home">Главная</Link></li>
